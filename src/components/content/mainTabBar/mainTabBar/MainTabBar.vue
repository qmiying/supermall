<template>
  <tab-bar>
    <tab-bar-item path="/home">
      ...
      <template v-slot:item-icon-active><img slot="item-icon-active" src="~assets/img/tabbar/home_active.svg" alt=""></template>
...
<script>
import TabBar from "components/commom/tabbar/TabBar.vue"
import TabBarItem from "components/commom/tabbar/TabBarItem.vue"
